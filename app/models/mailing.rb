class Mailing < ActiveRecord::Base
  ...
  acts_as_criteria :i18n                 => lambda { |text| I18n.t(text) },
                 ...
                 #TEST :restrict => { :method  => "my", :options => lambda { |current_user| { :user => current_user, :order => current_user.pref[:accounts_sort_by] || Account.sort_by } } },
  ...
  #FIXME validate :users_for_shared_access
