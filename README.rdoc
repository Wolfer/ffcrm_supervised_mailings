==Supervised Mailings plugin for Fat Free CRM on Rails 3


Supervised mass-mailing app for FatFreeCrm. I'm just get https://github.com/tractis/crm_supervised_mailings version and rewrite it for work with Rails 3.
